        ...
        <div className="max-w-2xl mx-auto text-center space-y-8">
          ...
          <div className="pt-4">
            <a
              ...
              className="inline-flex items-center gap-2 bg-black hover:bg-gray-900 text-white px-8 py-3 text-lg font-semibold rounded-full border border-white shadow-lg hover:shadow-xl transition-all duration-200"
